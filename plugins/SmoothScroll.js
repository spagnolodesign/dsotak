...
class Item {
    constructor(el) {
        ...
        this.DOM.caption = this.DOM.el.querySelector('.item__caption-title');
        this.renderedStyles = {
            ...
            innerTranslationY: {
                ...
                maxValue: parseInt(getComputedStyle(this.DOM.image).getPropertyValue('--overflow'), 20),
            ...
            titleTranslationY: {
                ...
                current: 0, 
                ease: 0.1,
                fromValue: Number(MathUtils.getRandomFloat(30,150)),
                setValue: () => {
    ...
    render() {
        ...
        for (const key in this.renderedStyles ) {
            ...
            const diff = this.renderedStyles[key].current - this.renderedStyles[key].previous
            const acc = diff / window.innerWidth
            const velo =+ acc
            this.renderedStyles[key].skew = velo * 150
        }
    ...
    layout() {
        ...
        // this.DOM.image.parentNode.style.transform = `skewY(${this.renderedStyles.innerTranslationY.skew}deg)`;
        this.DOM.caption.style.transform = `translate3d(0,${this.renderedStyles.titleTranslationY.previous}px,0)`;
    }
}
